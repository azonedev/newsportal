  ...
  <script type="{{asset('/assets/admin/text/javascript')}}" language="javascript" src="lib/advanced-datatable/js/jquery.js"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      nCloneTd.innerHTML = '<img src="{{asset('assets/admin/lib/advanced-datatable/images/details_open.png')}}">';
